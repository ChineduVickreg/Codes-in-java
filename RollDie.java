...
// A program to roll a six-sided die 60,000,000 times
...
public class RollDie {
    public static void main(String[] args){
        ...
        for (int roll = 1; roll <= 60_000_000; roll++){
            ...
            switch (face) {
                case 1:
                    ++frequency1; //increment the 1s count
                     break;
                case 2:
                    ++frequency2; //increment the 2s count
                    break;
                case 3:
                    ++frequency3; // increment the 3s count
                    break;
                case 4:
                    ++frequency4; // increment the 4s count
                    break;
                case 5:
                    ++frequency5; // increment the 5s count
                    break;
                case 6:
                    ++frequency6; //increment the 6s count
                    break;
            }
        }
