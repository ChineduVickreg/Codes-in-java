...
// Program to create a a game of throwing two die called CRAPS
...
public class CrapsGame {
    ...
    //create an ENUM type with constants that represent the game status
    ...
    public static void main(String[] args) {
        ...
        switch (sumOfDice) {
            ...
            case BOX_CARS: // lose with 12 on the first roll
                ...
                break;
            default://did not win or loss, so remember point
